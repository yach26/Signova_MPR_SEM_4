    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <div className="text-center">
          ...
          >
            AI Sign Language Learning{" "}
            <span className="text-primary">&</span> Detection Platform
          </motion.h1>
          ...
          >
            Learn sign language, practice with quizzes, and translate signs in
            real time using AI-powered detection. Start your journey to
          ...
          >
            {[
              { label: "Signs Available", value: "36+" },
              { label: "Quiz Levels", value: "3" },
              { label: "Real-time Detection", value: "AI" },
              { label: "Text to Speech", value: "Yes" },
            ].map((stat) => (
